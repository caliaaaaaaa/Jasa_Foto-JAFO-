...
<style>
	/* UTAMA: container utama halaman user */
	.container-user {
		background: #ffffff;
		padding: 30px;
		border-radius: 20px;
	...
	/* HEADER: area tombol tambah + search */
	.header-user {
		display: flex;
	...
	/* tombol aksi (edit, aktif/nonaktif) */
	.btn-aksi {
		padding: 7px 12px;
		border-radius: 8px;
		text-decoration: none;
...
<div class="container-user">
	...
	<div class="header-user">
		...
		<!-- tombol menuju form tambah user -->
		<a href="<?= base_url('admin/form_tambah') ?>" class="btn-tambah">
			<i class="fa fa-plus-circle" style="margin-right: 8px;"></i> Tambah User
		</a>

		<!-- form pencarian user -->
		<form method="get" action="<?= base_url('admin/users') ?>" class="search-form">

			<!-- input keyword untuk mencari username atau nama -->
