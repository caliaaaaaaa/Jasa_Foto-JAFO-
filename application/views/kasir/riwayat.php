...
/* Membungkus seluruh isi halaman riwayat transaksi */
.container-riwayat {
    background: #ffffff;
    padding: 30px;
    border-radius: 20px;
...
/* Input untuk mencari data transaksi */
.search-box {
    padding: 10px 15px;
    border-radius: 12px;
...
.table-riwayat {
    ...
    background: white;
    font-size: 13px;
    min-width: 1100px; /* Agar kolom tidak terlalu sempit */
}
...
/* Tombol untuk melihat/cetak struk */
.btn-struk {
    padding: 7px 14px;
    background: #3B6FB6;
    color: white;
...
<div class="container-riwayat">
    ...
    <div class="header-riwayat">
        ...
        <!-- FORM SEARCH -->
        <!-- Mengirim keyword ke controller untuk filter data -->
        ...
        <table class="table-riwayat">
            ...
            <tbody>
                ...
                <?php if(!empty($riwayat)): ?>
                    ...
                    // Looping data riwayat dari database
                    ...
                    <tr>
                        ...
                        <!-- Tombol aksi -->
                        <td>
                            <a href="<?= base_url('kasir/cetak_struk/'.$r->id_transaction) ?>" 
                               target="_blank" 
                               class="btn-struk">
